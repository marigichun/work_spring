...
public class JUnitTest {
	...
	@Before
	public void setUp() {	//암호화로 사용자에 넣음
	...
	public void addAndGetUsers() throws UsersException, BoardException {
		 ...
		 */
		usersDao.deleteAllUsersAuthority();//사용자마다 권한이 있기에 권한에 대한 테이블 삭제
		...
		assertThat(usersDao.getCount(), is(3));//3명에 대한 카운터가 같으면 통과
